  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
      ...
      <div className="flex-1 space-y-6">
        ...
        <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-50 to-slate-50 text-blue-700 rounded-xl text-sm font-semibold border border-blue-200 shadow-lg backdrop-blur-sm animate-fade-in-down">
          <span className="w-2 h-2 bg-gradient-to-r from-emerald-400 to-emerald-600 rounded-full mr-2 animate-pulse"></span>
          Open to Full-Stack roles · Bay Area or Remote
        </div>

        {/* Enhanced Main Content */}
        <div className="space-y-4">
          <h1 className="text-4xl lg:text-5xl font-bold text-gradient leading-tight animate-fade-in-up">
            Derya Kendirci
          </h1>

          <h2 className="text-xl lg:text-2xl font-semibold text-blue-700 animate-fade-in-up" style={{animationDelay: '0.1s'}}>
          ...
          <p className="text-sm lg:text-base text-slate-500 max-w-4xl leading-relaxed animate-fade-in-up" style={{animationDelay: '0.3s'}}>
      ...
      <div className="flex-shrink-0 animate-fade-in-right" style={{animationDelay: '0.5s'}}>
        <div className="avatar-ring">
          <div className="w-40 h-40 rounded-full overflow-hidden shadow-inner">
            {!imageError ? (
              <Image
                src="/profile.jpg"
