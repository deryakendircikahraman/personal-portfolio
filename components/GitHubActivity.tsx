        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-7 gap-1">
            {contributions.map((contribution, index) => (
              <div
                key={index}
                className={`w-3 h-3 rounded-sm transition-all duration-200 hover:scale-110 cursor-pointer border border-transparent hover:border-[#0969da] ${getContributionColor(contribution.count)}`}
